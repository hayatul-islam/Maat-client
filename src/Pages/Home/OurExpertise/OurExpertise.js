      ...
      <Container>
        ...
        <Row>
          {expertises.map((expertise, index) => (
            <Col key={expertise?._id} xs={12} lg={6}>
              <div id={`cardIndex${index + 1}`} className="expertise-card">
                {index + 1 <= 9 ? (
                  <h1 className="text-end text-muted fw-normal cardIndex">
                    0{index + 1}
                  </h1>
                ) : (
                  <h1 className="text-end text-muted fw-normal cardIndex">
                ...
                <div className="pt-5 my-4">
                  ...
                  >
                    SEE MORE{" "}
                    <Image src="https://uploads-ssl.webflow.com/6160407763f5cd74b27c2405/6160407763f5cd15737c241e_icon-arrow-black-diag.svg" />
                  </a>
                </div>
              </div>
            </Col>
