        ...
        <Row className="">
          <Col xs={12} lg={8}>
            <div className="big-font clarexTitle">
              <h1>Your Growth</h1>
              <h1>Our Priority </h1>
              <h4 className="clarexDescription">
                Commanding the goals of future!
              </h4>
            </div>
          </Col>
          <Col xs={12} lg={4}>
            <div className="clarexImg">
              <img
                src="https://i.ibb.co/b1qMpnq/success-concept-ladder-with-glowing-light-bulb-1017-32076-2-removebg-preview.png"
                alt=""
              />
            </div>
          </Col>
