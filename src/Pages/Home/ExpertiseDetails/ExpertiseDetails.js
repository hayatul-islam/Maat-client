        ...
        <div className='pb-5'>
            <Container>
                <div className='pb-3 sticky-top'>
                    <Link className='backBtn ' to="/expertises"><i className="fas fa-times"></i></Link>
                </div>
                <Row>
                    ...
                    <div className='py-5'>
                        <a href="#expertise">
                            <Image className='downLinkImage' src='https://uploads-ssl.webflow.com/6160407763f5cd74b27c2405/6160407763f5cd9df77c2423_icon-arrow-white.svg' />
                        </a>
                    </div>
                </Row>
